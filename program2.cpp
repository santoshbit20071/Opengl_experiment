  ...
  public:
    ...
    void Run(GLFWwindow* window, Program& shader_program, GLuint vao, GLuint tid) {
      while (!glfwWindowShouldClose(window)) {
        ...
        model = glm::rotate(model, (GLfloat)glfwGetTime()/200 * 50.0f, glm::vec3(0.0f, 0.0f,1.0f));
...
int main(int argc, char* argv[]) {
  ...
  Program shader_program("../prog2_vertexshader.vs", "../prog2_fragmentshader.frag");
